...
```
/plugin marketplace add goodkavin/void-reference-architecture
```

## Who

[Void Engineering](https://voidengineer.ing), Bangkok. Fractional CTO and data platform work for SMEs. The Instagram series `#reference-architecture` at [@voidengineer.ing](https://www.instagram.com/voidengineer.ing/) is the cover for each card here.
